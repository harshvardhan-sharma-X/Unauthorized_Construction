...
def update_all(data, basemap_style):
    ...
    current_style = "open-street-map" if basemap_style == "streets" else "white-bg"

    fig.update_layout(
        showlegend=False,
        mapbox_style = current_style, 
        margin={"r":0,"t":0,"l":0,"b":0},  # empty canvas
        mapbox_layers=[
            {
                "below": 'traces',   # important — put below your markers
                "sourcetype": "raster",
                "source": ["https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}"],
                "visible": basemap_style in ["satellite", "satellite-streets"]   # ← control visibility
            },
            {
                "below": 'traces',
                "sourcetype": "raster",
                "source": ["https://services.arcgisonline.com/ArcGIS/rest/services/Reference/World_Boundaries_and_Places/MapServer/tile/{z}/{y}/{x}"], # Only show road labels if Hybrid is selected
